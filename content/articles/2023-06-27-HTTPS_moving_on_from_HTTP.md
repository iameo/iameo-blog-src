...
slug: https-moving-on-from-ec2-http date: 2023-06-27 23:34 
author: Emmanuel Okwudike 
category: DevOps 
tags: ssl, https, aws, flask, api, ubuntu, nginx, web development, devOps, backend summary: _I move on from HTTP to HTTPS; for security and other benefits_
...
>>NoRecords FATAL\
No valid A or AAAA records could be ultimately resolved for emvoip.com.ng. This means that Let's Encrypt would not be able to connect to your domain to perform HTTP validation, since it would not know where to connect to.
...
<div style="text-align: center">
    <img src="https://media3.giphy.com/media/RMMNGb1KGmIX9LFei6/giphy.gif?cid=ecf05e47h9yx982kwvqc1u054g3zw1h3fbgqtg4dl8hn0tfc&ep=v1_gifs_search&rid=giphy.gif&ct=g" alt="close curtain!" width="400" height="300">
</div>
